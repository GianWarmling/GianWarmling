...
print("Seja muito bem vindo ao Guess Number do Gian")
...
while True:
    answer_user = input("Adivimhe o número: ")
    ...
    if answer_user == random_number:
        print("Acertou\nO número sorteado é:", random_number)
        break
...
print("Número de tentativas: ", n_choices)
